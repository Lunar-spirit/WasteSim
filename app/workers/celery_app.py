...
design AD-18). Only "ingest" has tasks yet; "simulate" and "optimize" are
added in Drop 2 when app/engine/ exists for them to call.
"""
...
celery_app = Celery(
    ...
    include=["app.workers.tasks_ingest", "app.workers.tasks_gis"],
)
